import svgPaths from "./svg-g159bwz7gv";
  ...
  return (
    <div className="bg-[#618c78] flex-[212_0_0] h-[48px] min-w-px relative rounded-[16px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-[106.35px] not-italic text-[16px] text-center text-white top-[11.4px] whitespace-nowrap">Entrar</p>
      </div>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="bg-[#f3f4f6] flex-[212_0_0] h-[48px] min-w-px relative rounded-[16px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-[106.01px] not-italic text-[#4a5565] text-[16px] text-center top-[11.4px] whitespace-nowrap">Cadastrar</p>
      </div>
    </div>
  );
}
...
function Container12() {
  return (
    <div className="h-[24.2px] relative shrink-0 w-full" data-name="Container">
      <p className="-translate-x-1/2 absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] left-[216.29px] not-italic text-[#096] text-[14px] text-center top-[2.8px] whitespace-nowrap">Esqueceu a senha?</p>
    </div>
  );
}
...
function Button2() {
  return (
    <div className="bg-[#618c78] h-[56px] relative rounded-[16px] shrink-0 w-full" data-name="Button">
      <p className="-translate-x-1/2 absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-[216.35px] not-italic text-[16px] text-center text-white top-[15.4px] whitespace-nowrap">Entrar</p>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] h-[322.2px] items-start relative shrink-0 w-full" data-name="Container">
      <Container6 />
      <Container9 />
      <Container12 />
      <Button2 />
...
function Container3() {
  return (
    <div className="h-[418.2px] relative shrink-0 w-[432px]" data-name="Container">
...
function Container2() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[691px] items-center justify-center left-[562px] px-[64px] py-[136.5px] rounded-bl-[76px] rounded-tl-[76px] top-0 w-[560px]" data-name="Container">
      <Container3 />
    </div>
  );
}

export default function TelaEntrarDesktop() {
  return (
    <div className="relative size-full" data-name="Tela-Entrar-Desktop">
      <Container />
      <Container2 />
